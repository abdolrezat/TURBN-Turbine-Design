function handles = fcn_M_2un(handles,stage_i)
...
% partII variables
alpha2 = handles.IN_S(1,stage_i);
%
Tt3 = handles.IN_S(2,stage_i);
...
V2 = V2_(u3_u2,alpha2,alpha3,sai,wr);
M2 = M2_(V2,Tt2,gc,y,R);
T2 = T_Tt(Tt2,M2,y);
